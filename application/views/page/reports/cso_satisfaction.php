...
<div class='title-module'>CSO Rating Satisfaction</div>
<div class="subtitle-module">Reports &raquo; CSO Rating Satisfaction</div>
...
<div class="card mt-2 " style="border-radius: 10px;">
	<div class="card-title head-module-action">
		<table>
			<thead>
				<tr>
					<th><span style="color:white"><i class="fa fa-list"></i> List CSO Rating Satisfaction</span>
		...
		<div class="row">
			<div class="table-responsive">
				<table class="table table-bordered display table-hover table-striped" id="tableReport"
					...
					<thead>
						<tr>
							<th rowspan="2">CSO ID</th>
							<th rowspan="2">CSO Name</th>
							<th colspan="5" style="text-align:center">Average Rating</th>
							<th rowspan="2" style="text-align:center">Total Voters</th>
						</tr>
						<tr>
							<th style="text-align:center">Friendliness</th>
							<th style="text-align:center">Solution</th>
							<th style="text-align:center">Price & Quality</th>
...
<script>
	...
	Highcharts.chart('chartData', {
		...
		title: {
			text: 'Total Rating Satisfaction Summary Log <?php echo date('d F Y', strtotime($tgl1)) . ' until ' . date('d F Y', strtotime($tgl2)); ?>'
		},
		xAxis: {
		...
		tooltip: {
			...
			formatter: function () {
				...
				s += '<br><b>AVR: ' + (total / 5).toFixed(2) + '</b>'; // Add the calculated total
