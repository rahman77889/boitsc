...
<div class='title-module'>Detail CSO Rating Satisfaction</div>
<div class="subtitle-module">Reports &raquo; Detail CSO Rating Satisfaction</div>
...
<div class="card mt-2 " style="border-radius: 10px;">
	<div class="card-title head-module-action">
		<table>
			<thead>
				<tr>
					<th><span style="color:white"><i class="fa fa-list"></i> List Detail CSO Rating Satisfaction</span>
				...
				<table class="table table-bordered display table-hover table-striped" id="tableReport"
					...
					<thead>
						<tr>
							...
							<th style="text-align:center" colspan="5">Rating</th>
						</tr>
						<tr>
