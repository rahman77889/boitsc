...
<div class='title-module'>Total Counter Summary Log</div>
<div class="subtitle-module">Reports &raquo; Total Counter Summary Log</div>
...
<div class="card mt-2 " style="border-radius: 10px;">
	<div class="card-title head-module-action">
		<table>
			<thead>
				<tr>
					<th><span style="color:white"><i class="fa fa-list"></i> List Counter Summary Log</span>
