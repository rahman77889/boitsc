...
<div class='title-module'>CSO Performance</div>
<div class="subtitle-module">Reports &raquo; CSO Performance</div>
...
<div class="card mt-2 " style="border-radius: 10px;">
	<div class="card-title head-module-action">
		<table>
			<thead>
				<tr>
					<th><span style="color:white"><i class="fa fa-list"></i> List CSO Performance</span>
