...
<div class='title-module'>Detail CSO Performance</div>
<div class="subtitle-module">Reports &raquo; Detail CSO Performance</div>
...
<div class="card mt-2 " style="border-radius: 10px;">
	<div class="card-title head-module-action">
		<table>
			<thead>
				<tr>
					<th><span style="color:white"><i class="fa fa-list"></i> List Detail CSO Performance</span>
				...
				<table class="table table-bordered display table-hover table-striped" id="tableReport" style="width:100%">
					<thead>
						<tr>
							...
							<th>Cust. MSISDN</th>
							<th>Cust. Name</th>
							<th style="text-align:center">Queue Number</th>
							<th>Activity</th>
						</tr>
					</thead>
					<tbody>
