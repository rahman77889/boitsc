<div class='title-module'>Group Inbox</div>
<div class="subtitle-module">Complaint Handling &raquo; Group Inbox</div>
<style>
    .bo {
        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <select name="status" id="" class="form-control j">
...
<script>
    ...
    function showTable() {
        ...
        $('#complaint').DataTable({
            ...
            "ajax": {
                "url": "<?= base_url("ComplainHandling/showdtcomplaint/"); ?>?" + $('#form-filter :input').serialize(),
                "type": "POST"
            },
