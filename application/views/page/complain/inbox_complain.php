<div class='title-module'>Inbox Complaint</div>
<div class="subtitle-module">Complaint Handling &raquo; Inbox Complaint</div>
<style>
    .bo {
...
<script>
    ...
    function showTable() {
        ...
        $('#complaint').DataTable({
            ...
            "ajax": {
                "url": "<?= base_url("ComplainHandling/showdtcomplaint/me"); ?>?" + $('#form-filter :input').serialize(),
                "type": "POST"
            },
