...
<div class="subtitle-module">Manage System &raquo; Counter Setting </div>
                    ...
                    <div class="card">
                        <form id="inForm" method="POST" action="javascript:void(0);" class="smart-form"
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-md-3">
                                        <label id="huruf" for="">*Counter Place</label><br>
                                        <label id="huruf" for="">*Counter</label><br>
                                        <label id="huruf" for="">*Number</label><br>
                                    </div>
                                    <div class="col-md-3">
                                        <select name="id_counter_setting" class="form-control form-control-sm">
                                            <?php
                                        ...
                                        <input type="text" name="counter" id="name" class="form-control jarak"
                                            placholder="Counter Number">
                                        <input type="text" name="nomor" id="email" class="form-control jarak"
                                            placholder="Counter Queuing Number">
                                    </div>
                        ...
                        <table class="table table-bordered display" id="contoh" style="width:100%">
                            <thead>
                                <tr>
                                    ...
                                    <th style="text-align: left"> Counter Place </th>
...
<script>
    ...
    function hapus(id) {
        $("#btn-delete").attr("href", "<?php echo base_url(); ?>Unit/deleteCounter/?id=" + id);
    }
    ...
    function edit(id = '') {
        ...
        if (id != '') {
            ...
            $.ajax({
                url: '<?= base_url("Unit/getCounter?id="); ?>' + id,
                type: 'GET',
                dataType: 'JSON'
            }).done(function (data) {
